...
const ElectricianScreen = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await homeAPI.getServiceDetails('Electrician');
                ...
                ListHeaderComponent={
                    <>
                        ...
                        <View style={styles.pageTitleContainer}>
                            ...
                            <View>
                                <Text style={styles.pageTitle}>ELECTRICIAN, PLUMBER</Text>
                                <Text style={[styles.pageTitle, { marginTop: 0 }]}>& CARPENTER</Text>
