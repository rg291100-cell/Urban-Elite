...
const PaintingScreen = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await homeAPI.getServiceDetails('Painting');
                ...
                ListHeaderComponent={
                    <>
                        ...
                        <View style={styles.pageTitleContainer}>
                            ...
                            <View>
                                <Text style={styles.pageTitle}>PAINTING &</Text>
                                <Text style={[styles.pageTitle, { marginTop: 0 }]}>WATERPROOFING</Text>
