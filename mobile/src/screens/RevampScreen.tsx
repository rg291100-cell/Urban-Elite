...
const RevampScreen = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await homeAPI.getServiceDetails('Revamp');
                setFilters(response.data.filters);
                setServices(response.data.services);
            } catch (error) {
                console.error('Failed to fetch Revamp data', error);
            } finally {
                setLoading(false);
            }
        };
                ...
                ListHeaderComponent={
                    <>
                        ...
                        <View style={styles.pageTitleContainer}>
                            ...
                            <View>
                                <Text style={styles.pageTitle}>WALL MAKEOVER BY</Text>
                                <Text style={[styles.pageTitle, { marginTop: 0 }]}>REVAMP</Text>
